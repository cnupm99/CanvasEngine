  ...
  define(function() {
    ...
    return ProgressBar = (function() {
      function ProgressBar(options) {
        ...
        this._colors = {
          backgroundColor: colors.backgroundColor || "#CCC",
          backgroundShadowColor: colors.backgroundShadowColor || "#000",
          progress5: colors.progress5 || ["#f63a0f", "#E72B00"],
          ...
          captionStroke: colors.captionStroke || "#000"
        };
      ...
      ProgressBar.prototype.animate = function(context) {
        var color, gradient, size, text, width;
        context.save();
        context.translate(this._position[0], this._position[1]);
        context.fillStyle = this._colors.backgroundColor;
        context.shadowColor = this._colors.backgroundShadowColor;
        context.shadowBlur = 2;
        context.shadowOffsetX = 0;
        context.shadowOffsetY = 0;
        context.fillRect(0, 0, this._sizes[0], this._sizes[1]);
        if (this._progress <= 5) {
          color = this._colors.progress5;
        ...
        context.fillRect(this._padding, this._padding, size, this._sizes[1] - this._padding * 2);
        text = "";
