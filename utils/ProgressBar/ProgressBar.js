...
(function() {
  ...
  define(function() {
    ...
    return ProgressBar = (function() {
      ...
      ProgressBar.prototype._textOptions = function(options) {
        var strokeCaption;
      ...
      ProgressBar.prototype._animateText = function() {
        var dy, text;
        if (this._text != null) {
          text = "";
          ...
          dy = FIREFIX ? 4 : 0;
          return this._text.move([this._position[0] + (this._size[0] - this._text.textWidth) / 2, this._position[1] + dy + (this._size[1] - this._text.fontHeight) / 2]);
        }
      };
