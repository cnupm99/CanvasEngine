...
(function() {
  ...
  define('DisplayObject',["base"], function(base) {
    var DisplayObject;
...
(function() {
  ...
  define('Image',["DisplayObject"], function(DisplayObject) {
    var Image;
...
(function() {
  ...
  define('Text',["DisplayObject"], function(DisplayObject) {
    var Text;
...
(function() {
  ...
  define('Graph',["DisplayObject"], function(DisplayObject) {
    var Graph;
...
(function() {
  ...
  define('TilingImage',["Image"], function(Image) {
    var TilingImage;
...
(function() {
  ...
  define('Scene',["base", "Image", "Text", "Graph", "TilingImage"], function(base, Image, Text, Graph, TilingImage) {
    var Scene;
...
(function() {
  "use strict";
  define('Scenes',["Scene"], function(Scene) {
    var Scenes;
...
(function() {
  ...
  define('CanvasEngine',["base", "Scenes", "FPS"], function(base, Scenes, FPS) {
    var CanvasEngine;
