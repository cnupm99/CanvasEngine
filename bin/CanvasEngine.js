...
(function() {
  ...
  define(function() {
    ...
    Graph = (function(superClass) {
      ...
      Graph.prototype.circle = function(centerX, centerY, radius) {
        this._commands.push({
          "command": "circle",
      ...
      Graph.prototype.arc = function(centerX, centerY, radius, beginAngle, endAngle, antiClockWise) {
        this._commands.push({
          "command": "arc",
          "center": this.pixel(centerX, centerY),
          "radius": this.int(radius),
        ...
        return this._commands.forEach((function(_this) {
          return function(command) {
            ...
            switch (command.command) {
              ...
              case "circle":
                _this.context.beginPath();
                return _this.context.arc(command.center[0] + _this._deltaX, command.center[1] + _this._deltaY, command.radius, 0, 2 * Math.PI, false);
              case "arc":
                _this.context.beginPath();
                return _this.context.arc(command.center[0] + _this._deltaX, command.center[1] + _this._deltaY, command.radius, command.beginAngle, command.endAngle, command.antiClockWise);
              case "gradient":
    ...
    Image = (function(superClass) {
      ...
      Image.prototype.getOptions = function() {
        var options;
        options = Image.__super__.getOptions.call(this);
    ...
    Text = (function(superClass) {
      ...
      Text.prototype.setUnderline = function(value, offset) {
      ...
      Text.prototype.animate = function() {
        ...
        return lines.forEach((function(_this) {
          return function(line) {
            ...
            if (_this.underline) {
              lineWidth = _this._getTextWidth(line);
              _this.context.strokeStyle = underlineStyle;
              _this.context.lineWidth = _this.strokeWidth || 1;
              _this.context.beginPath();
              _this.context.moveTo(_this._deltaX, textY + fontSize + _this.underlineOffset);
              _this.context.lineTo(_this._deltaX + lineWidth, textY + fontSize + _this.underlineOffset);
      ...
      Text.prototype.getOptions = function() {
        var options;
        options = Text.__super__.getOptions.call(this);
