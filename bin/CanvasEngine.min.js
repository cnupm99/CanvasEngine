// version 1.10, build 75, Wed Aug 23 2017
...
!0;return this.rect};b.prototype.animate=function(){if(this.loaded)return this.context.beginPath(),this.context.fillStyle=this.context.createPattern(this.image,"repeat"),this.context.rect(this.rect[0],this.rect[1],this.rect[2],this.rect[3]),this.context.fill()};return b}(k);var t=function(d){function b(a){var c=a.parent||document.body;this.canvas=document.createElement("canvas");this.canvas.style.position="absolute";c.appendChild(this.canvas);this.context=this.canvas.getContext("2d");b.__super__.constructor.call(this,
a);this.type="scene";this.setZIndex(a.zIndex);this.setMask(a.mask);this.needAnimation=!1}e(b,d);b.prototype.add=function(a){if(null!=a.type){null==a.visible&&(a.visible=this.visible);null==a.shadow&&(a.shadow=this.shadow);a.canvas=this.canvas;a.context=this.context;switch(a.type){case "image":var b=new k(a);break;case "text":b=new q(a);break;case "graph":b=new m(a);break;case "tile":b=new r(a)}this.childrens.push(b);return b}};b.prototype.setMask=function(a){this.mask=null!=a&&a?a:!1;this.needAnimation=
!0;return this.mask};b.prototype.setZIndex=function(a){this.zIndex=this["int"](a);return this.canvas.style.zIndex=this.zIndex};b.prototype.hide=function(){b.__super__.hide.call(this);return this.context.clearRect(0,0,this.size[0],this.size[1])};b.prototype.move=function(a,c){b.__super__.move.call(this,a,c);this.canvas.style.left=this.position[0]+"px";this.canvas.style.top=this.position[1]+"px";return this.position};b.prototype.resize=function(a,c){b.__super__.resize.call(this,a,c);this.canvas.width=
...
this.center);null==a.rotation&&(a.rotation=this.rotation);null==a.alpha&&(a.alpha=this.alpha);null==a.mask&&(a.mask=this.mask);null==a.shadow&&(a.shadow=this.shadow);a.parent=this.parent;a=new t(a);this.childrens.push(a);this.setActive(a.name);return a};b.prototype._animate=function(){this._beforeAnimate.forEach(function(a){return a()});this.needAnimation=!1;this.childrens.forEach(function(a){return function(b){var c=b.needAnimation||b.childrens.some(function(a){return a.needAnimation});a.needAnimation=
a.needAnimation||c;if(c)return b.animate()}}(this));return this._render=requestAnimationFrame(this._animate)};return b}(f)})}).call(this);