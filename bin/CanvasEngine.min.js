// version 1.10, build 103, Thu Dec 28 2017
...
this.zoom(a.scale);this.rotate(a.rotation);this.setAlpha(a.alpha);this.setShadow(a.shadow);return this.needAnimation=!0};var h=function(a){a=d.call(this,a)||this;a.childrens=[];return a};$jscomp.inherits(h,d);h.prototype.get=function(a){a=this.index(a);return-1===a?!1:this.childrens[a]};h.prototype.remove=function(a){a=this.index(a);if(-1===a)return!1;this.childrens.splice(a,1);return!0};h.prototype.rename=function(a,b){var c=this.index(a);if(-1===c)return!1;this.childrens[c].name=b;return!0};h.prototype.index=
function(a){var b=-1;this.childrens.some(function(c,d){var p;(p=c.name===a)&&(b=d);return p});return b};var e=function(a){a=d.call(this,a)||this;a.type="graph";a._commands=[];return a};$jscomp.inherits(e,d);e.prototype.clear=function(){this._commands=[];return this.needAnimation=!0};e.prototype.beginPath=function(){return this._commands.push({command:"beginPath"})};e.prototype.lineCap=function(a){return this._commands.push({command:"lineCap",lineCap:a})};e.prototype.strokeStyle=function(a){return this._commands.push({command:"strokeStyle",
style:a})};e.prototype.fillStyle=function(a){return this._commands.push({command:"fillStyle",style:a})};e.prototype.linearGradient=function(a,b,c,d,e){return this._commands.push({command:"gradient",point1:this.pixel(a,b),point2:this.pixel(c,d),colors:e})};e.prototype.lineWidth=function(a){return this._commands.push({command:"lineWidth",width:this["int"](a)})};e.prototype.setLineDash=function(a){return this._commands.push({command:"setDash",dash:a})};e.prototype.lineDashOffset=function(a){return this._commands.push({command:"dashOffset",
offset:this["int"](a)})};e.prototype.moveTo=function(a,b){return this._commands.push({command:"moveTo",point:this.pixel(a,b)})};e.prototype.lineTo=function(a,b){this._commands.push({command:"lineTo",point:this.pixel(a,b)});return this.needAnimation=!0};e.prototype.line=function(a,b,c,d){this._commands.push({command:"line",from:this.pixel(a,b),to:this.pixel(c,d)});return this.needAnimation=!0};e.prototype.rect=function(a,b,c,d,e){e=void 0===e?0:e;this._commands.push({command:"rect",point:this.pixel(a,
b),size:this.pixel(c,d),radius:this["int"](e)});return this.needAnimation=!0};e.prototype.circle=function(a,b,c){this._commands.push({command:"circle",center:this.pixel(a,b),radius:this["int"](c)});return this.needAnimation=!0};e.prototype.arc=function(a,b,c,d,e,f){this._commands.push({command:"arc",center:this.pixel(a,b),radius:this["int"](c),beginAngle:this.deg2rad(d),endAngle:this.deg2rad(e),antiClockWise:f||!1});return this.needAnimation=!0};e.prototype.polyline=function(a,b){var c=this;b=void 0===
b?!0:b;this._commands.push({command:"beginPath"});this.moveTo(a[0][0],a[0][1]);a.forEach(function(a){return c.lineTo(a[0],a[1])});b&&this.stroke();return this.needAnimation=!0};e.prototype.polygon=function(a){this.polyline(a,!1);this.lineTo(a[0][0],a[0][1]);this.stroke();return this.fill()};e.prototype.fill=function(){this._commands.push({command:"fill"});return this.needAnimation=!0};e.prototype.stroke=function(){this._commands.push({command:"stroke"});return this.needAnimation=!0};e.prototype.animate=
function(){var a=this;if(this.visible)return d.prototype.animate.call(this),this.context.lineCap="round",this._commands.forEach(function(b){switch(b.command){case "beginPath":return a.context.beginPath();case "lineCap":return a.context.lineCap=b.lineCap;case "stroke":return a.context.stroke();case "fill":return a.context.fill();case "setDash":return a.context.setLineDash(b.dash);case "dashOffset":return a.context.lineDashOffset=b.offset;case "moveTo":return a.context.moveTo(b.point[0]+a._deltaX,b.point[1]+
a._deltaY);case "lineTo":return a.context.lineTo(b.point[0]+a._deltaX,b.point[1]+a._deltaY);case "line":return a.context.beginPath(),a.context.moveTo(b.from[0]+a._deltaX,b.from[1]+a._deltaY),a.context.lineTo(b.to[0]+a._deltaX,b.to[1]+a._deltaY),a.context.stroke();case "strokeStyle":return a.context.strokeStyle=b.style;case "fillStyle":return a.context.fillStyle=b.style;case "lineWidth":return a.context.lineWidth=b.width;case "rect":return a.context.beginPath(),0===b.radius?a.context.rect(b.point[0]+
...
b.point1[1]+a._deltaY,b.point2[0]+a._deltaX,b.point2[1]+a._deltaY);b.colors.forEach(function(a){return c.addColorStop(a[0],a[1])});return a.context.fillStyle=c}});this.needAnimation=!1};e.prototype.log=function(){return console.log(this._commands)};e.prototype._drawRoundedRect=function(a,b,c,d,e,f){var p=Math.PI;var g=p/2;var h=b+f;var k=b+d-f;var l=c+f;var m=c+e-f;a.moveTo(h,c);a.lineTo(k,c);a.arc(k,l,f,-g,0);a.lineTo(b+d,m);a.arc(k,m,f,0,g);a.lineTo(h,c+e);a.arc(h,m,f,g,p);a.lineTo(b,l);return a.arc(h,
l,f,p,3*g)};var n=function(a){var b=d.call(this,a)||this;b._imageOnLoad=b._imageOnLoad.bind(b);b.type="image";b.onload=a.onload;b.loaded=!1;b.image=document.createElement("img");b.image.onload=b._imageOnLoad;b.loadedFrom="";b.setRect(a.rect);null!=a.src?b.src(a.src):b.from(a.from);return b};$jscomp.inherits(n,d);n.prototype.setRect=function(a){this.rect=a||!1;this.needAnimation=!0;return this.rect};n.prototype.src=function(a){this.loaded=!1;this.loadedFrom=a;return this.image.src=a};n.prototype.from=
function(a,b){if(null!=a)return this.image=a,this.loadedFrom=b||"",this.upsize([this.image.width,this.image.height]),(0>=this.size[0]||0>=this.size[1])&&this.resize(this.realSize),this.needAnimation=this.loaded=!0};n.prototype.animate=function(){if(this.loaded){if(this.visible)return d.prototype.animate.call(this),this.rect?this.context.drawImage(this.image,this.rect[0],this.rect[1],this.rect[2],this.rect[3],this._deltaX,this._deltaY,this.size[0],this.size[1]):this.size[0]===this.realSize[0]&&this.size[1]===
this.realSize[1]?this.context.drawImage(this.image,this._deltaX,this._deltaY):this.context.drawImage(this.image,this._deltaX,this._deltaY,this.size[0],this.size[1]);this.needAnimation=!1}};n.prototype._imageOnLoad=function(a){g(this,n);this.upsize([this.image.width,this.image.height]);(0>=this.size[0]||0>=this.size[1])&&this.resize(this.realSize);this.needAnimation=this.loaded=!0;if(null!=this.onload)return this.onload(this.realSize)};var m=function(a){var b=d.call(this,a)||this;b.type="text";b.fontHeight=
0;b.textWidth=0;b.setFont(a.font);b.setFillStyle(a.fillStyle);b.setStrokeStyle(a.strokeStyle);b.setStrokeWidth(a.strokeWidth);b.setUnderline(a.underline,a.underlineOffset);b.write(a.text);return b};$jscomp.inherits(m,d);m.prototype.setFont=function(a){this.font=a||"12px Arial";this.fontHeight=this._getFontHeight(this.font);this.needAnimation=!0;return this.font};m.prototype.setFillStyle=function(a){this.fillStyle=a||!1;this.needAnimation=!0;return this.fillStyle};m.prototype.setStrokeStyle=function(a){this.strokeStyle=
a||!1;this.needAnimation=!0;return this.strokeStyle};m.prototype.setStrokeWidth=function(a){this.strokeWidth=null!=a?this["int"](a):1;this.needAnimation=!0;return this.strokeWidth};m.prototype.setUnderline=function(a,b){this.underline=a||!1;this.underlineOffset=b||0;this.needAnimation=!0;return this.underline};m.prototype.write=function(a){this.text=a||"";this.upsize(this._getRealSizes(this.text));this.textWidth=this.realSize[0];this.textHeight=this.realSize[1];this.needAnimation=!0;return this.text};
m.prototype.animate=function(){var a=this;if(this.visible){d.prototype.animate.call(this);this.context.font=this.font;this.context.textBaseline="top";if(this.fillStyle)if(Array.isArray(this.fillStyle)){var b=this.context.createLinearGradient(this._deltaX,this._deltaY,this._deltaX,this._deltaY+this.fontHeight);this.fillStyle.forEach(function(a){return b.addColorStop(a[0],a[1])});this.context.fillStyle=b}else this.context.fillStyle=this.fillStyle;this.strokeStyle&&(this.context.strokeStyle=this.strokeStyle,
this.context.lineWidth=this.strokeWidth);var c=this.text.split("\n");var e=this._deltaY;if(this.underline){var f=parseInt(this.font,10);var g=this.strokeStyle||this.fillStyle}return c.forEach(function(b){a.fillStyle&&a.context.fillText(b,a._deltaX,e);a.strokeStyle&&a.context.strokeText(b,a._deltaX,e);a.underline&&(b=a._getTextWidth(b),a.context.strokeStyle=g,a.context.lineWidth=a.strokeWidth||1,a.context.beginPath(),a.context.moveTo(a._deltaX,e+f+a.underlineOffset),a.context.lineTo(a._deltaX+b,e+
f+a.underlineOffset),a.context.stroke());return e+=a.fontHeight})}this.needAnimation=!1};m.prototype._getFontHeight=function(a){var b=document.createElement("span");b.appendChild(document.createTextNode("height"));b.style.cssText="font: "+a+"; white-space: nowrap; display: inline;";document.body.appendChild(b);a=b.offsetHeight;document.body.removeChild(b);return a};m.prototype._getTextWidth=function(a){this.context.save();this.context.font=this.font;a=this.context.measureText(a).width;this.context.restore();
return a};m.prototype._getRealSizes=function(a){var b=this;var c=0;a=this.text.split("\n");a.forEach(function(a){a=b._getTextWidth(a);if(a>c)return c=a});return[c,a.length*this.fontHeight]};var q=function(a){var b=n.call(this,a)||this;b.type="tile";b.setRect(a.rect);return b};$jscomp.inherits(q,n);q.prototype.setRect=function(a){this.rect=a||[0,0,this.canvas.width,this.canvas.height];this.needAnimation=!0;return this.rect};q.prototype.animate=function(){if(this.loaded){if(this.visible)return this.context.beginPath(),
this.context.fillStyle=this.context.createPattern(this.image,"repeat"),this.context.rect(this.rect[0],this.rect[1],this.rect[2],this.rect[3]),this.context.fill(),this.needAnimation=!1;this.needAnimation=!1}};var l=function(a){var b=h.call(this,a)||this;b.type="scene";b.setZIndex(a.zIndex);b.setMask(a.mask);b.needAnimation=!1;return b};$jscomp.inherits(l,h);l.prototype.add=function(a){if(null!=a.type){null==a.visible&&(a.visible=this.visible);null==a.shadow&&(a.shadow=this.shadow);a.canvas=this.canvas;
a.context=this.context;switch(a.type){case "image":var b=new n(a);break;case "text":b=new m(a);break;case "graph":b=new e(a);break;case "tile":b=new q(a)}this.childrens.push(b);return b}};l.prototype.setMask=function(a){this.mask=null!=a&&a?a:!1;this.needAnimation=!0;return this.mask};l.prototype.setZIndex=function(a){this.zIndex=this["int"](a);return this.canvas.style.zIndex=this.zIndex};l.prototype.hide=function(){h.prototype.hide.call(this);return this.context.clearRect(0,0,this.size[0],this.size[1])};
l.prototype.move=function(a,b){h.prototype.move.call(this,a,b);this.canvas.style.left=this.position[0]+"px";this.canvas.style.top=this.position[1]+"px";return this.position};l.prototype.shiftAll=function(a,b){b=void 0===b?0:b;return this.childrens.forEach(function(c){return c.shift(a,b)})};l.prototype.resize=function(a,b){h.prototype.resize.call(this,a,b);this.canvas.width=this.size[0];this.canvas.height=this.size[1];return this.size};l.prototype.setCenter=function(a,b){h.prototype.setCenter.call(this,
a,b);this.context.translate(this.center[0],this.center[1]);return this.center};l.prototype.setAnchor=function(a,b){h.prototype.setAnchor.call(this,a,b);this.context.translate(this.center[0],this.center[1]);return this.anchor};l.prototype.rotate=function(a){h.prototype.rotate.call(this,a);this.context.rotate(this._rotation);return this.rotation};l.prototype.setAlpha=function(a){h.prototype.setAlpha.call(this,a);return this.context.globalAlpha=this.alpha};l.prototype.animate=function(){var a=this;if(this.visible)return this.context.clearRect(0,
0,this.size[0],this.size[1]),this.mask&&(this.context.beginPath(),this.context.rect(this.mask[0],this.mask[1],this.mask[2],this.mask[3]),this.context.clip()),this.childrens.forEach(function(b){a.context.save();b.animate();return a.context.restore()}),this.needAnimation=!1;this.needAnimation=!1};var k=function(a){var b=h.call(this,a)||this;b._animate=b._animate.bind(b);if(!b.canvasSupport())return console.log("your browser not support canvas and/or context"),!1;b.parent=a.parent||document.body;0===
b.size[0]&&0===b.size[1]&&(b.size=[b["int"](b.parent.clientWidth),b["int"](b.parent.clientHeight)]);b._beforeAnimate=[];b._scene="default";b.add({type:"scene",name:"default"});b.start();return b};$jscomp.inherits(k,h);k.prototype.add=function(a){var b;null==a&&(a={});if("scene"===(a.type||"scene"))return this._createScene(a);(b=this.get(a.scene))||(b=this.getActive());b||(b=this.add({type:"scene",name:"default"}));return b.add(a)};k.prototype.remove=function(a){a=this.index(a);if(-1===a)return!1;
this.parent.removeChild(this.childrens[a].canvas);this.childrens.splice(a,1);return!0};k.prototype.onTop=function(a){var b=0;var c=!1;this.childrens.forEach(function(d){d.zIndex>b&&(b=d.zIndex);if(a===d.name)return c=d});c&&c.setZIndex(b+1);return c};k.prototype.getActive=function(){var a;(a=this.get(this._scene))||(a=this.childrens[0]);a||(a=!1);return a};k.prototype.setActive=function(a){this._scene=a||"default";return this.getActive()};k.prototype.start=function(){return this._render=requestAnimationFrame(this._animate)};
k.prototype.stop=function(){return cancelAnimationFrame(this._render)};k.prototype.addEvent=function(a){return this._beforeAnimate.push(a)};k.prototype.removeEvent=function(a){var b=this;return this._beforeAnimate.forEach(function(c,d){if(c===a)return b._beforeAnimate.splice(d,1)})};k.prototype.fullscreen=function(a){if(void 0===a||a)if(null!=this.parent.requestFullScreen)this.parent.requestFullScreen();else if(null!=this.parent.webkitRequestFullScreen)this.parent.webkitRequestFullScreen();else if(null!=
...
document.mozFullscreenElement)};k.prototype.canvasSupport=function(){return null!=document.createElement("canvas").getContext};k.prototype._createScene=function(a){null==a.visible&&(a.visible=this.visible);null==a.position&&(a.position=this.position);null==a.size&&(a.size=this.size);null==a.center&&(a.center=this.center);null==a.rotation&&(a.rotation=this.rotation);null==a.alpha&&(a.alpha=this.alpha);null==a.mask&&(a.mask=this.mask);null==a.shadow&&(a.shadow=this.shadow);a.parent=this.parent;a=new l(a);
this.childrens.push(a);this.setActive(a.name);return a};k.prototype._animate=function(){var a=this;g(this,k);this._beforeAnimate.forEach(function(b,c){return"function"===typeof b?b():a._beforeAnimate.splice(c,1)});this.needAnimation=!1;this.childrens.forEach(function(b){var c=b.needAnimation||b.childrens.some(function(a){return a.needAnimation});a.needAnimation=a.needAnimation||c;if(c)return b.animate()});return this._render=requestAnimationFrame(this._animate)};return k})}).call(this);