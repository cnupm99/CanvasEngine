// version 1.10, build 108, Wed Jan 31 2018
...
a.forEach(function(a){a=b._getTextWidth(a);if(a>c)return c=a});return[c,a.length*this.fontHeight]};m.prototype.getOptions=function(){var a=d.prototype.getOptions.call(this);a.fontHeight=this.fontHeight;a.textWidth=this.textWidth;a.textHeight=this.textHeight;a.font=this.font;a.fillStyle=this.fillStyle;a.strokeStyle=this.strokeStyle;a.strokeWidth=this.strokeWidth;a.underline=this.underline;a.underlineOffset=this.underlineOffset;a.text=this.text;return a};var q=function(a){var b=n.call(this,a)||this;
b.type="tile";b.setRect(a.rect);return b};$jscomp.inherits(q,n);q.prototype.setRect=function(a){this.rect=a||[0,0,this.canvas.width,this.canvas.height];this.needAnimation=!0;return this.rect};q.prototype.animate=function(){if(this.loaded){if(this.visible)return this.context.beginPath(),this.context.fillStyle=this.context.createPattern(this.image,"repeat"),this.context.rect(this.rect[0],this.rect[1],this.rect[2],this.rect[3]),this.context.fill(),this.needAnimation=!1;this.needAnimation=!1}};var l=
function(a){var b=h.call(this,a)||this;b.type="scene";b.setZIndex(a.zIndex);b.setMask(a.mask);b.needAnimation=!1;return b};$jscomp.inherits(l,h);l.prototype.add=function(a){if(null!=a.type){null==a.visible&&(a.visible=this.visible);null==a.shadow&&(a.shadow=this.shadow);a.canvas=this.canvas;a.context=this.context;switch(a.type){case "image":var b=new n(a);break;case "text":b=new m(a);break;case "graph":b=new e(a);break;case "tile":b=new q(a)}this.childrens.push(b);return b}};l.prototype.clone=function(a){return this.add(a.getOptions())};
