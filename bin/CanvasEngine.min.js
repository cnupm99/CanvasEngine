// version 1.10, build 85, Sat Sep 02 2017
...
this._deltaX,this._deltaY,this.size[0],this.size[1]);this.needAnimation=!1}};b.prototype._imageOnLoad=function(a){this.upsize([this.image.width,this.image.height]);(0>=this.size[0]||0>=this.size[1])&&this.resize(this.realSize);this.needAnimation=this.loaded=!0;if(null!=this.onload)return this.onload(this.realSize)};return b}(g);var q=function(d){function b(a){b.__super__.constructor.call(this,a);this.textWidth=this.fontHeight=0;this.setFont(a.font);this.setFillStyle(a.fillStyle);this.setStrokeStyle(a.strokeStyle);
this.setStrokeWidth(a.strokeWidth);this.write(a.text)}e(b,d);b.prototype.setFont=function(a){this.font=a||"12px Arial";this.fontHeight=this._getFontHeight(this.font);this.needAnimation=!0;return this.font};b.prototype.setFillStyle=function(a){this.fillStyle=a||!1;this.needAnimation=!0;return this.fillStyle};b.prototype.setStrokeStyle=function(a){this.strokeStyle=a||!1;this.needAnimation=!0;return this.strokeStyle};b.prototype.setStrokeWidth=function(a){this.strokeWidth=null!=a?this["int"](a):1;this.needAnimation=
!0;return this.strokeWidth};b.prototype.write=function(a){this.text=a||"";this.upsize(this._getRealSizes(this.text));this.textWidth=this.realSize[0];this.textHeight=this.realSize[1];this.needAnimation=!0;return this.text};b.prototype.animate=function(){if(this.visible){b.__super__.animate.call(this);this.context.font=this.font;this.context.textBaseline="top";if(this.fillStyle)if(Array.isArray(this.fillStyle)){var a=this.context.createLinearGradient(this._deltaX,this._deltaY,this._deltaX,this._deltaY+
this.fontHeight);this.fillStyle.forEach(function(b){return a.addColorStop(b[0],b[1])});this.context.fillStyle=a}else this.context.fillStyle=this.fillStyle;this.strokeStyle&&(this.context.strokeStyle=this.strokeStyle,this.context.lineWidth=this.strokeWidth);var c=this.text.split("\n");var f=this._deltaY;return c.forEach(function(a){return function(b){a.fillStyle&&a.context.fillText(b,a._deltaX,f);a.strokeStyle&&a.context.strokeText(b,a._deltaX,f);return f+=a.fontHeight}}(this))}this.needAnimation=
!1};b.prototype._getFontHeight=function(a){var b=document.createElement("span");b.appendChild(document.createTextNode("height"));b.style.cssText="font: "+a+"; white-space: nowrap; display: inline;";document.body.appendChild(b);a=b.offsetHeight;document.body.removeChild(b);return a};b.prototype._getTextWidth=function(a){this.context.save();this.context.font=this.font;a=this.context.measureText(a).width;this.context.restore();return a};b.prototype._getRealSizes=function(a){var b=0;a=this.text.split("\n");
a.forEach(function(a){return function(c){c=a._getTextWidth(c);if(c>b)return b=c}}(this));return[b,a.length*this.fontHeight]};return b}(g);var r=function(d){function b(a){b.__super__.constructor.call(this,a);this.setRect(a.rect)}e(b,d);b.prototype.setRect=function(a){this.rect=a||[0,0,this.canvas.width,this.canvas.height];this.needAnimation=!0;return this.rect};b.prototype.animate=function(){if(this.loaded){if(this.visible)return this.context.beginPath(),this.context.fillStyle=this.context.createPattern(this.image,
"repeat"),this.context.rect(this.rect[0],this.rect[1],this.rect[2],this.rect[3]),this.context.fill(),this.needAnimation=!1;this.needAnimation=!1}};return b}(k);var t=function(d){function b(a){var c=a.parent||document.body;this.canvas=document.createElement("canvas");this.canvas.style.position="absolute";c.appendChild(this.canvas);this.context=this.canvas.getContext("2d");b.__super__.constructor.call(this,a);this.type="scene";this.setZIndex(a.zIndex);this.setMask(a.mask);this.needAnimation=!1}e(b,
d);b.prototype.add=function(a){if(null!=a.type){null==a.visible&&(a.visible=this.visible);null==a.shadow&&(a.shadow=this.shadow);a.canvas=this.canvas;a.context=this.context;switch(a.type){case "image":var b=new k(a);break;case "text":b=new q(a);break;case "graph":b=new m(a);break;case "tile":b=new r(a)}this.childrens.push(b);return b}};b.prototype.setMask=function(a){this.mask=null!=a&&a?a:!1;this.needAnimation=!0;return this.mask};b.prototype.setZIndex=function(a){this.zIndex=this["int"](a);return this.canvas.style.zIndex=
this.zIndex};b.prototype.hide=function(){b.__super__.hide.call(this);return this.context.clearRect(0,0,this.size[0],this.size[1])};b.prototype.move=function(a,c){b.__super__.move.call(this,a,c);this.canvas.style.left=this.position[0]+"px";this.canvas.style.top=this.position[1]+"px";return this.position};b.prototype.shiftAll=function(a,b){null==b&&(b=0);return this.childrens.forEach(function(c){return c.shift(a,b)})};b.prototype.resize=function(a,c){b.__super__.resize.call(this,a,c);this.canvas.width=
this.size[0];this.canvas.height=this.size[1];return this.size};b.prototype.setCenter=function(a,c){b.__super__.setCenter.call(this,a,c);this.context.translate(this.center[0],this.center[1]);return this.center};b.prototype.setAnchor=function(a,c){b.__super__.setAnchor.call(this,a,c);this.context.translate(this.center[0],this.center[1]);return this.anchor};b.prototype.rotate=function(a){b.__super__.rotate.call(this,a);this.context.rotate(this._rotation);return this.rotation};b.prototype.setAlpha=function(a){b.__super__.setAlpha.call(this,
a);return this.context.globalAlpha=this.alpha};b.prototype.animate=function(){if(this.visible)return this.context.clearRect(0,0,this.size[0],this.size[1]),this.mask&&(this.context.beginPath(),this.context.rect(this.mask[0],this.mask[1],this.mask[2],this.mask[3]),this.context.clip()),this.childrens.forEach(function(a){return function(b){a.context.save();b.animate();return a.context.restore()}}(this)),this.needAnimation=!1;this.needAnimation=!1};return b}(h);return function(d){function b(a){this._animate=
p(this._animate,this);if(!this.canvasSupport())return console.log("your browser not support canvas and/or context"),!1;b.__super__.constructor.call(this,a);this.parent=a.parent||document.body;0===this.size[0]&&0===this.size[1]&&(this.size=[this["int"](this.parent.clientWidth),this["int"](this.parent.clientHeight)]);this._beforeAnimate=[];this._scene="default";this.add({type:"scene",name:"default"});this.start()}e(b,d);b.prototype.add=function(a){var b;null==a&&(a={});if("scene"===(a.type||"scene"))return this._createScene(a);
(b=this.get(a.scene))||(b=this.getActive());b||(b=this.add({type:"scene",name:"default"}));return b.add(a)};b.prototype.remove=function(a){a=this.index(a);if(-1===a)return!1;this.parent.removeChild(this.childrens[a].canvas);this.childrens.splice(a,1);return!0};b.prototype.onTop=function(a){var b=0;var d=!1;this.childrens.forEach(function(c){c.zIndex>b&&(b=c.zIndex);if(a===c.name)return d=c});d&&d.setZIndex(b+1);return d};b.prototype.getActive=function(){var a;(a=this.get(this._scene))||(a=this.childrens[0]);
...
function(a){null==a&&(a=!0);if(a)if(null!=this.parent.requestFullScreen)this.parent.requestFullScreen();else if(null!=this.parent.webkitRequestFullScreen)this.parent.webkitRequestFullScreen();else if(null!=this.parent.mozRequestFullScreen)this.parent.mozRequestFullScreen();else return!1;else if(null!=document.cancelFullScreen)document.cancelFullScreen();else if(null!=document.webkitCancelFullScreen)document.webkitCancelFullScreen();else if(null!=document.mozCancelFullScreen)document.mozCancelFullScreen();
else if(null!=document.exitFullScreen)document.exitFullScreen();else return!1;return!0};b.prototype.isFullscreen=function(){return null!=(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullscreenElement)};b.prototype.canvasSupport=function(){return null!=document.createElement("canvas").getContext};b.prototype._createScene=function(a){null==a.visible&&(a.visible=this.visible);null==a.position&&(a.position=this.position);null==a.size&&(a.size=this.size);null==a.center&&(a.center=
this.center);null==a.rotation&&(a.rotation=this.rotation);null==a.alpha&&(a.alpha=this.alpha);null==a.mask&&(a.mask=this.mask);null==a.shadow&&(a.shadow=this.shadow);a.parent=this.parent;a=new t(a);this.childrens.push(a);this.setActive(a.name);return a};b.prototype._animate=function(){this._beforeAnimate.forEach(function(a){return function(b,d){return"function"===typeof b?b():a._beforeAnimate.splice(d,1)}}(this));this.needAnimation=!1;this.childrens.forEach(function(a){return function(b){var c=b.needAnimation||
b.childrens.some(function(a){return a.needAnimation});a.needAnimation=a.needAnimation||c;if(c)return b.animate()}}(this));return this._render=requestAnimationFrame(this._animate)};return b}(h)})}).call(this);