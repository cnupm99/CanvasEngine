// version 1.10, build 105, Thu Jan 25 2018
...
a.context=this.context;switch(a.type){case "image":var b=new n(a);break;case "text":b=new m(a);break;case "graph":b=new e(a);break;case "tile":b=new q(a)}this.childrens.push(b);return b}};l.prototype.clear=function(){this.childrens=[];return this.needAnimation=!0};l.prototype.setMask=function(a){this.mask=null!=a&&a?a:!1;this.needAnimation=!0;return this.mask};l.prototype.setZIndex=function(a){this.zIndex=this["int"](a);return this.canvas.style.zIndex=this.zIndex};l.prototype.hide=function(){h.prototype.hide.call(this);
return this.context.clearRect(0,0,this.size[0],this.size[1])};l.prototype.move=function(a,b){h.prototype.move.call(this,a,b);this.canvas.style.left=this.position[0]+"px";this.canvas.style.top=this.position[1]+"px";return this.position};l.prototype.shiftAll=function(a,b){b=void 0===b?0:b;return this.childrens.forEach(function(c){return c.shift(a,b)})};l.prototype.resize=function(a,b){h.prototype.resize.call(this,a,b);this.canvas.width=this.size[0];this.canvas.height=this.size[1];return this.size};
