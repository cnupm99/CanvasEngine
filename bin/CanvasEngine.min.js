// version 1.11, build 4, Tue Feb 06 2018
...
function(a){return this._beforeAnimate.forEach(function(b){return function(c,d){if(c===a)return b._beforeAnimate.splice(d,1)}}(this))};b.prototype.fullscreen=function(a,b){null==a&&(a=!0);b||(b=this.parent);if(a)if(null!=b.requestFullScreen)b.requestFullScreen();else if(null!=b.webkitRequestFullScreen)b.webkitRequestFullScreen();else if(null!=b.mozRequestFullScreen)b.mozRequestFullScreen();else if(null!=b.msRequestFullscreen)b.msRequestFullscreen();else return!1;else if(null!=document.cancelFullScreen)document.cancelFullScreen();
else if(null!=document.webkitCancelFullScreen)document.webkitCancelFullScreen();else if(null!=document.mozCancelFullScreen)document.mozCancelFullScreen();else if(null!=document.exitFullScreen)document.exitFullScreen();else if(null!=document.msExitFullscreen)document.msExitFullscreen();else return!1;return!0};b.prototype.isFullscreen=function(){return null!=(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullscreenElement||document.msFullscreenElement)};b.prototype.canvasSupport=
function(){return null!=document.createElement("canvas").getContext};b.prototype._createScene=function(a){null==a.visible&&(a.visible=this.visible);null==a.position&&(a.position=this.position);null==a.size&&(a.size=this.size);null==a.center&&(a.center=this.center);null==a.rotation&&(a.rotation=this.rotation);null==a.alpha&&(a.alpha=this.alpha);null==a.mask&&(a.mask=this.mask);null==a.shadow&&(a.shadow=this.shadow);a.parent=this.parent;a=new t(a);this.childrens.push(a);this.setActive(a.name);return a};
b.prototype._animate=function(){this._beforeAnimate.forEach(function(a){return function(b,d){return"function"===typeof b?b():a._beforeAnimate.splice(d,1)}}(this));this.needAnimation=!1;this.childrens.forEach(function(a){return function(b){var c=b.needAnimation||b.childrens.some(function(a){return a.needAnimation});a.needAnimation=a.needAnimation||c;if(c)return b.animate()}}(this));return this._render=requestAnimationFrame(this._animate)};return b}(k)})}).call(this);