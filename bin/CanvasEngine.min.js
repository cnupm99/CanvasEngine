...
this._rect[1],this._rect[2],this._rect[3]),a.fill(),a.restore(),this.needAnimation=!1};return b}(r);var u=function(d){function b(a){b.__super__.constructor.call(this,a);this.name=a.name;this.canvas=document.createElement("canvas");this.canvas.style.position="absolute";this.setZ(a.zIndex);this.context=this.canvas.getContext("2d");this.setTransform(a);this._needAnimation=this._mask=!1;this.objects=[]}h(b,d);b.prototype.setZ=function(a){this._zIndex=this._int(a);return this.canvas.style.zIndex=this._zIndex};
b.prototype.getZ=function(){return this._zIndex};b.prototype.add=function(a){if(null!=a.type){a.parent={};a.parent.context=this.context;a.parent.position=this._position;a.parent.sizes=this._sizes;switch(a.type){case "image":var b=new r(a);break;case "text":b=new m(a);break;case "graph":b=new p(a);break;case "tile":b=new t(a)}this.objects.push(b);b.getScene=function(a){return function(){return a}}(this);return b}};b.prototype.get=function(a){var b=!1;this.objects.some(function(c){var d;(d=c.name===
a)&&(b=c);return d});return b};b.prototype.remove=function(a){var b=-1;this.objects.some(function(c,d){var e;(e=c.name===a)&&(b=d);return e});return-1<b?(this.objects.splice(b,1),!0):!1};b.prototype.addChild=function(a){this.objects.push(a);return this._needAnimation=!0};b.prototype.removeChild=function(a){var b=-1;this.objects.some(function(c,d){var e;(e=c===a)&&(b=d);return e});return-1<b?(this.objects.splice(b,1),!0):!1};b.prototype.needAnimation=function(){return this._needAnimation||this.objects.some(function(a){return a.needAnimation})};
b.prototype.testPoint=function(a,b){var c=this.context.getImageData(a,b,1,1).data;null==c.every&&(c.every=Array.prototype.every);return!c.every(function(a){return 0===a})};b.prototype.testRect=function(a,b){var c=this._position[0];var d=this._position[1];var f=this._position[0]+this._sizes[0];var g=this._position[1]+this._sizes[1];return a>=c&&a<=f&&b>=d&&b<=g};b.prototype.getSizes=function(){return this._sizes};b.prototype.setMask=function(a,b,d,f){this._mask=4>arguments.length?!1:{x:this._int(a),
y:this._int(b),width:this._int(d),height:this._int(f)};return this._needAnimation=!0};b.prototype.setTransform=function(a){this.setSizes(a.sizes);this.setPosition(a.position);this.setCenter(a.center);this.setRotation(a.rotation);return this.setAlpha(a.alpha)};b.prototype.setSizes=function(a){null!=a&&(this._sizes=this._point(a));this.canvas.width=this._sizes[0];this.canvas.height=this._sizes[1];return this._needAnimation=!0};b.prototype.setPosition=function(a){null!=a&&(this._position=this._point(a));
this.canvas.style.left=this._position[0]+"px";this.canvas.style.top=this._position[1]+"px";return this._needAnimation=!0};b.prototype.setCenter=function(a){null!=a&&(this._center=this._point(a));this.context.translate(this._center[0],this._center[1]);return this._needAnimation=!0};b.prototype.setRotation=function(a){null!=a&&(this._rotation=this._value(a));this.context.rotation=this._rotation*Math.PI/180;return this._needAnimation=!0};b.prototype.setAlpha=function(a){null!=a&&(this._alpha=this._value(a));
...
this._scene.add({type:"text",fillStyle:"#FF0000",font:"10px Arial",position:[48,1]});this.start();this._onTimer()}d.prototype.start=function(){this._counter=this._updateCounter=this._FPSValue=0;return this._interval=setInterval(this._onTimer,1E3)};d.prototype.stop=function(){clearInterval(this._interval);return this._counter=this._updateCounter=this._FPSValue=0};d.prototype._onTimer=function(){var b,a;this._FPSValue=this._counter;this._counter=0;this._updateValue=this._updateCounter;this._updateCounter=
0;this._values.push([this._FPSValue,this._updateValue]);84===this._values.length&&this._values.shift();this._graph.clear();this._graph.fillStyle("#000");this._graph.rect(0,0,90,40);this._graph.fill();var c=b=0;for(a=this._values.length;0<=a?b<a:b>a;c=0<=a?++b:--b){var d=87-this._values.length+c;var f=this._values[c][0];c=this._values[c][1];this._graph.strokeStyle("#00FF00");this._graph.line(d,37,d,37-23*f/60);this._graph.strokeStyle("#FF0000");this._graph.line(d,37,d,37-23*c/60)}this._caption.setText("FPS: "+
this._FPSValue);return this._caption2.setText("UPS: "+this._updateValue)};d.prototype.update=function(b){this._counter++;if(b)return this._updateCounter++};return d}();return function(d){function b(a){this._animate=q(this._animate,this);if(!this._canvasSupport())return console.log("your browser not support canvas and/or context"),!1;b.__super__.constructor.call(this,a);this._parent=a.parent||document.body;this.scenes=new v(this._parent);this._beforeAnimate=[];if(this._showFPS=null!=a.showFPS?a.showFPS:
!0)a=this.scenes.create({name:"FPS",sizes:[90,40],position:[this._sizes[0]-95,5],zIndex:99999,setActive:!1}),this._FPS=new w({scene:a});this.start()}h(b,d);b.prototype.start=function(){return this._render=requestAnimationFrame(this._animate)};b.prototype.stop=function(){return cancelAnimationFrame(this._render)};b.prototype.addEvent=function(a){return this._beforeAnimate.push(a)};b.prototype.removeEvent=function(a){return this._beforeAnimate.forEach(function(b){return function(c,d){if(c===a)return b._beforeAnimate.splice(d,
1)}}(this))};b.prototype.add=function(a){if("scene"===(a.type||"scene"))return null==a.sizes&&(a.sizes=this._sizes),null==a.position&&(a.position=this._position),this.scenes.create(a);var b=a.scene||this.scenes.active()||"default";return this.scenes.create({name:b,sizes:this._sizes,position:this._position}).add(a)};b.prototype._canvasSupport=function(){return null!=document.createElement("canvas").getContext};b.prototype._animate=function(){var a;this._beforeAnimate.forEach(function(a){if("function"===
typeof a)return a()});(a=this.scenes.needAnimation())&&this.scenes.animate();this._showFPS&&this._FPS.update(a);return this._render=requestAnimationFrame(this._animate)};return b}(f)})}).call(this);